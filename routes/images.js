...
router.get('/albums', verifyToken, imageController.listAlbums);
router.post('/albums', verifyToken, imageController.createAlbum);
...
router.post('/:id/album', verifyToken, imageController.assignImageAlbum);
